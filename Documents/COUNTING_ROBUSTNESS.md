...
- En sensor som mister helse, mister sitt spor og kan ikke komme inn igjen i samme episode. Hvis quorum forsvinner, kreves en ny tomperiode før neste forsøk.
...
Begge ROI-er må være gyldige og ferske for at sensoren kan delta i telling. Tidsgrensen for gamle målinger tilpasses målebudsjettet. Readiness, quorum og helsediagnostikk bruker samme helseregel. En fjerde sensor som kommer tilbake uten kalibrering, kan kalibreres mens de tre andre er i drift og åpningen er tom.
...
| `standing_timeout` / `blocked_timeout` | Diagnostikk for langvarig aktivitet, uten tvungen godkjenning |
